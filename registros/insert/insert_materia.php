...
//if( mysqli_connect_error())
 ...
 // mysqli_set_charset($connexion,"utf8");
  ...
  $instruccion_SQL = "INSERT INTO materias (descripcionmateria)
  VALUES ('$_POST[descripcionmateria]')";
...
todo a su paso*/
   ...
   }  else
   {
       ...
       echo "<table><tr><td>descripcion materia:'$_POST[descripcionmateria]'</td></tr>";
