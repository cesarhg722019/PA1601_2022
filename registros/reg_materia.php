...
body{
  ...
  <form action="insert/insert_materia.php" name="formulario1" method="post"
...
formulario el archivo que se va a enviar la informacion '
  ...
  <tr>
      ...
      <td><label for="descripcionmateria"></label>
      <input type="text" name="descripcionmateria" id="descripcionmateria" /></td>
