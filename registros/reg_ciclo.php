...
body{
  ...
  <h1 align="center"> Registro del ciclo escolar</h1>

  <form action="insert/insert_ciclo.php" name="formulario1" method="post"
...
formulario el archivo que se va a enviar la informacion '
  ...
  <tr>
      ...
      <td><label for="descripcionciclo"></label>
      <input type="text" name="descripcionciclo" id="descripcionciclo" /></td>
